...
public class Combination : NetworkBehaviour {
    ...
    public void StartCombination()
    {
        ...
        CmdOnStart(correctCombination, checkAtCompletion, startTime, comObj);
    ...
    [Command]
    void CmdAddSelection(string code)
    {

        RpcAddSelection(code);

    }

    [ClientRpc]
    void RpcAddSelection(string code)
    {
    ...
    [Command]
    void CmdOnStart(string[] correctCombination, bool checkAtCompletion, int startTime, GameObject comObj)
    {
        
        RpcOnStart(correctCombination, checkAtCompletion, startTime, comObj);

    }

    [ClientRpc]
    void RpcOnStart(string[] correctCombination, bool checkAtCompletion, int startTime, GameObject comObj)
    {
