...
public class ObjectContent : Interactable {
    ...
    public static int getPlayerNetworkId(GameObject player)
    {
       ...
       return (int) player.GetComponent<NetworkIdentity>().netId.Value;
    ...
    public override void Interact(ArmTool armTool) {
        ...
        networkInstance = armTool.gameObject.GetComponent<NetworkIdentity>().netId;
        ...
        currentPlayerId = networkInstance.Value;
