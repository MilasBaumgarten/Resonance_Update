...
public class CollectContent : MonoBehaviour {
    ...
    private NetworkInstanceId networkInstance;
    ...
    void Start() {
        ...
        networkInstance = player.GetComponent<NetworkIdentity>().netId;
    ...
    public void CollectCont() {
        ...
        if (!ObjectContent.currentBothPlayers)
        {
            ...
            if(networkInstance.Value != ObjectContent.currentPlayerId)
            {
                //print("wrong player");
                return;
        ...
        if (networkInstance.Value == ObjectContent.currentPlayerId && ObjectContent.currentType != "special")
        {
